  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        ...
        <img src="https://iconape.com/wp-content/files/pc/371080/svg/371080.svg" alt="Yame.vn" style="width: 40px;">
      </a>
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="#ao">Áo thun đơn giản</a></li>
              <li><a class="dropdown-item" href="#ao">Áo sơ mi đơn giản</a></li>
              <li><a class="dropdown-item" href="#quan">Quần dài đơn giản</a></li>
              <li><a class="dropdown-item" href="#quan">Quần short đơn giản</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="#">Gu Thần Cổ Đại</a></li>
              <li><a class="dropdown-item" href="#">Gu Ngân Hà</a></li>
              <li><a class="dropdown-item" href="#">Gu Dị Biệt</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li><a class="dropdown-item" href="#non">Nón</a></li>
            </ul>
          </li>
        </ul>
            ...
            <div class="cart_link" id="cart_link">
              <div class="card card-body bg-dark cart-info">
                ...
                <div class="footer-cart">
                  <span class="text-light">Có <span class="lenghtCart">{{ getlengthcarts }}</span> sản phẩm trong giỏ
                    hàng </span>
